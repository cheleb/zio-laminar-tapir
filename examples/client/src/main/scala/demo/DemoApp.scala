...
val myApp =
  ...
  div(
    ...
    styleAttr := "display: flex; align-items: flex-start; gap: 1rem;",
    TabGroup(_.placement.start)(
      ...
      Tab(_.panel := "streamingDifferentOrigin")("Streaming Different Origin"),
      ...
      TabPanel(_.name := "streamingDifferentOrigin")(streamingDifferentOrigin),
